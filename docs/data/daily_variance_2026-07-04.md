...
- **DET** Drew Sommers — 2 apps / 35 pitches over last 3 games — monitor
- **CIN** Brock Burke — 2 apps / 37 pitches over last 3 games — monitor
- **STL** Justin Bruihl — 2 apps / 54 pitches over last 3 games — monitor
- **ATL** Dylan Lee — 2 apps / 35 pitches over last 3 games — monitor
...
- TOR @ SEA — TOR faces RHP (Logan Gilbert)
- BAL @ CIN — CIN faces RHP (Brandon Young)
- BAL @ CIN — BAL faces RHP (Hunter Greene)
- TB @ HOU — HOU faces RHP (Drew Rasmussen)
- TB @ HOU — TB faces RHP (Hunter Brown)
- CWS @ CLE — CLE faces RHP (Sean Burke)
- CWS @ CLE — CWS faces LHP (Parker Messick)
- STL @ CHC — CHC faces RHP (Kyle Leahy)
- STL @ CHC — STL faces LHP (Shota Imanaga)
- NYM @ ATL — ATL faces LHP (Sean Manaea)
- NYM @ ATL — NYM faces LHP (Chris Sale)
- SF @ COL — SF faces RHP (Tomoyuki Sugano)
- PHI @ KC — KC faces LHP (Jesús Luzardo)
- PHI @ KC — PHI faces RHP (Michael Wacha)
- BOS @ LAA — LAA faces RHP (Sonny Gray)
- BOS @ LAA — BOS faces LHP (Sam Aldegheri)
- MIA @ ATH — ATH faces RHP (Sandy Alcantara)
- MIA @ ATH — MIA faces RHP (Aaron Civale)
- MIL @ AZ — AZ faces RHP (Brandon Woodruff)
- MIL @ AZ — MIL faces RHP (Merrill Kelly)
- SD @ LAD — LAD faces RHP (Griffin Canning)
- SD @ LAD — SD faces RHP (Yoshinobu Yamamoto)
