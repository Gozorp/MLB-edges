...
- **PHI** Jonathan Bowlan — 2 apps / 40 pitches over last 3 games — monitor
- **TOR** Adam Macko — 2 apps / 48 pitches over last 3 games — monitor
- **TOR** Connor Seabold — 2 apps / 36 pitches over last 3 games — monitor
...
- NYY @ CLE — NYY faces RHP (Gavin Williams)
- PHI @ TOR — TOR faces LHP (Cristopher Sánchez)
- PHI @ TOR — PHI faces LHP (Patrick Corbin)
- HOU @ LAA — LAA faces RHP (Spencer Arrighetti)
- HOU @ LAA — HOU faces RHP (Grayson Rodriguez)
- CIN @ SD — SD faces LHP (Andrew Abbott)
- CIN @ SD — CIN faces RHP (Walker Buehler)
- WSH @ SF — SF faces RHP (Miles Mikolas)
- WSH @ SF — WSH faces RHP (Logan Webb)
- MIL @ ATH — ATH faces LHP (Kyle Harrison)
- MIL @ ATH — MIL faces LHP (Jeffrey Springs)
