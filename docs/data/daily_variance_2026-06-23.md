...
_Generated 2026-06-23T07:09:52Z · 15 games · significant deviations only_
...
- **BAL** [DFA] — Baltimore Orioles designated CF Michael Siani for assignment.
...
- **HOU @ TOR** (home SP Shane Bieber): thin sample / PENDING_SP_DATA — Shane Bieber has only 0 Statcast pitches season-to-date; need 100+ to score
- **BOS @ COL** (home SP Sean Sullivan): thin sample / PENDING_SP_DATA — Sean Sullivan has only 49 Statcast pitches season-to-date; need 100+ to score
- **ATL @ SD** (home SP TBD): NOT CONFIRMED — probable SP not posted

## 3 · Bullpen Fatigue (last 3 games)
- **HOU** AJ Blubaugh — 2 apps / 54 pitches over last 3 games — monitor
- **TOR** Louis Varland — 2 apps / 40 pitches over last 3 games — monitor
- **TB** Cole Sulser — 2 apps / 38 pitches over last 3 games — monitor
- **TEX** Jacob Latz — 2 apps / 44 pitches over last 3 games — monitor
- **TEX** Kumar Rocker — threw 76 pitches last night — likely unavailable
- **MIA** Calvin Faucher — 2 apps / 36 pitches over last 3 games — monitor
- **NYY** Ryan Yarbrough — 2 apps / 60 pitches over last 3 games — monitor
- **PHI** Alan Rangel — threw 72 pitches last night — likely unavailable
- **LAD** Eric Lauer — threw 84 pitches last night — likely unavailable
- **LAD** Jonathan Hernández — 2 apps / 51 pitches over last 3 games — monitor
- **MIN** Eric Orze — 2 apps / 35 pitches over last 3 games — monitor
- **CWS** Grant Taylor — 2 apps / 50 pitches over last 3 games — monitor
- **CWS** Seranthony Domínguez — 2 apps / 49 pitches over last 3 games — monitor
- **COL** Brennan Bernardino — 2 apps / 39 pitches over last 3 games — monitor
- **LAA** Brent Suter — 2 apps / 55 pitches over last 3 games — monitor
- **SD** Adrian Morejon — 2 apps / 47 pitches over last 3 games — monitor
- **SD** Mason Miller — 2 apps / 41 pitches over last 3 games — monitor
...
- KC @ TB — KC faces LHP (Shane McClanahan)
- TEX @ MIA — MIA faces RHP (Cal Quantrill)
- TEX @ MIA — TEX faces RHP (Sandy Alcantara)
- NYY @ DET — DET faces LHP (Carlos Rodón)
- NYY @ DET — NYY faces RHP (Casey Mize)
- PHI @ WSH — WSH faces LHP (Jesús Luzardo)
- PHI @ WSH — PHI faces RHP (Zack Littell)
- CHC @ NYM — NYM faces RHP (Edward Cabrera)
- CHC @ NYM — CHC faces RHP (Kodai Senga)
- MIL @ CIN — CIN faces RHP (Brandon Sproat)
- MIL @ CIN — MIL faces LHP (Nick Lodolo)
- LAD @ MIN — MIN faces LHP (Justin Wrobleski)
- LAD @ MIN — LAD faces LHP (Kendry Rojas)
- CLE @ CWS — CWS faces LHP (Parker Messick)
- CLE @ CWS — CLE faces RHP (Sean Burke)
- AZ @ STL — STL faces LHP (Eduardo Rodriguez)
- AZ @ STL — AZ faces RHP (Kyle Leahy)
