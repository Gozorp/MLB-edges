...
- **DET** [signed] — Detroit Tigers signed free agent RHP Kevin Tejada to a minor league contract.
...
- **NYM** [outrighted] — New York Mets sent SS Vidal Bruján outright to Syracuse Mets.
- **PHI** [signed] — Philadelphia Phillies signed free agent LHP Kolby Allard to a minor league contract.
...
- **PIT** [signed] — Pittsburgh Pirates signed free agent RHP Saul Aguero to a minor league contract.
...
- **SEA** [signed] — Seattle Mariners signed free agent RHP Ferny Barreda to a minor league contract.
...
- **MIN** [outrighted] — Minnesota Twins sent SS Orlando Arcia outright to St. Paul Saints.
...
- **MIL @ ATL** (away SP Kyle Harrison): very high K% (29.7% vs lg 22.0)
- **MIL @ ATL** (home SP Chris Sale): very high K% (28.1% vs lg 22.0)
...
- **NYY** Jake Bird — 2 apps / 37 pitches over last 3 games — monitor
- **TOR** Spencer Miles — 2 apps / 42 pitches over last 3 games — monitor
- **TOR** Tyler Rogers — 2 apps / 39 pitches over last 3 games — monitor
- **CHC** Hoby Milner — 2 apps / 41 pitches over last 3 games — monitor
- **WSH** Miles Mikolas — threw 85 pitches last night — likely unavailable
...
- SF @ MIA — SF faces RHP (Max Meyer)
- MIL @ ATL — ATL faces LHP (Kyle Harrison)
- MIL @ ATL — MIL faces LHP (Chris Sale)
- CLE @ HOU — HOU faces LHP (Joey Cantillo)
- CLE @ HOU — CLE faces RHP (Spencer Arrighetti)
- NYM @ PHI — PHI faces RHP (Freddy Peralta)
...
- BOS @ SEA — SEA faces LHP (Connelly Early)
- BOS @ SEA — BOS faces RHP (Emerson Hancock)
- MIN @ AZ — AZ faces RHP (Taj Bradley)
- MIN @ AZ — MIN faces RHP (Zac Gallen)
