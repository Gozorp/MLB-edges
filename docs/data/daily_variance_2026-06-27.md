...
- **COL @ MIN** (away SP TBD): NOT CONFIRMED — probable SP not posted
- **CHC @ MIL** (away SP TBD): NOT CONFIRMED — probable SP not posted
- **MIA @ STL** (away SP TBD): NOT CONFIRMED — probable SP not posted
- **MIA @ STL** (home SP TBD): NOT CONFIRMED — probable SP not posted
...
- TEX @ TOR — TEX faces RHP (Dylan Cease)
- CIN @ PIT — PIT faces RHP (Chase Burns)
- CIN @ PIT — CIN faces RHP (Jared Jones)
- PHI @ NYM — NYM faces RHP (Alan Rangel)
- KC @ CWS — CWS faces RHP (Michael Wacha)
- KC @ CWS — KC faces RHP (Davis Martin)
- AZ @ TB — TB faces RHP (Jose Cabrera)
- WSH @ BAL — BAL faces LHP (Foster Griffin)
- WSH @ BAL — WSH faces RHP (Brandon Young)
- SEA @ CLE — CLE faces RHP (Logan Gilbert)
- SEA @ CLE — SEA faces RHP (Slade Cecconi)
- COL @ MIN — COL faces RHP (Mike Paredes)
- CHC @ MIL — CHC faces LHP (Kyle Harrison)
- LAD @ SD — SD faces RHP (Yoshinobu Yamamoto)
- LAD @ SD — LAD faces RHP (Randy Vásquez)
- ATL @ SF — SF faces RHP (Bryce Elder)
- ATH @ LAA — LAA faces RHP (Jack Perkins)
- ATH @ LAA — ATH faces LHP (Reid Detmers)
