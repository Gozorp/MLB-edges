...
- **SEA @ PIT** (away SP Bryce Miller): very high K% (28.1% vs lg 22.0)
...
- **HOU** Logan VanWey — 2 apps / 39 pitches over last 3 games — monitor
- **PHI** Chase Shugart — 2 apps / 36 pitches over last 3 games — monitor
- **TOR** Tyler Rogers — 2 apps / 37 pitches over last 3 games — monitor

## 4 · Lineup / Platoon
- KC @ TB — TB faces RHP (Seth Lugo)
- KC @ TB — KC faces LHP (Ian Seymour)
- SEA @ PIT — PIT faces RHP (Bryce Miller)
- SEA @ PIT — SEA faces RHP (Bubba Chandler)
- ATH @ SF — SF faces LHP (Jeffrey Springs)
