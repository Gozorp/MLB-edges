...
_Suppressed 7 minor/cosmetic move(s) (ASG/NUM); 2 unrecognized code-type(s) -> logs/unknown_tx_codes.log._

## 2 · Starting Pitcher Flags
- **SF @ MIA** (home SP Lake Bachar): very high K% (28.3% vs lg 22.0)
- **MIL @ ATL** (away SP Jacob Misiorowski): very high K% (38.4% vs lg 22.0)
- **SD @ TEX** (home SP Jacob deGrom): very high K% (28.9% vs lg 22.0)
...
- CWS @ DET — DET faces LHP (Brandon Eisert)
- CWS @ DET — CWS faces LHP (Tarik Skubal)
- CIN @ NYY — NYY faces RHP (Rhett Lowder)
- CIN @ NYY — CIN faces RHP (Cam Schlittler)
- WSH @ TB — TB faces LHP (PJ Poulin)
- WSH @ TB — WSH faces RHP (Griffin Jax)
- SF @ MIA — MIA faces RHP (Landen Roupp)
- SF @ MIA — SF faces RHP (Lake Bachar)
- MIL @ ATL — ATL faces RHP (Jacob Misiorowski)
- MIL @ ATL — MIL faces LHP (Martín Pérez)
- SD @ TEX — TEX faces RHP (Randy Vásquez)
- SD @ TEX — SD faces RHP (Jacob deGrom)
- CLE @ HOU — HOU faces RHP (Tanner Bibee)
- CLE @ HOU — CLE faces RHP (Tatsuya Imai)
- STL @ KC — KC faces RHP (Michael McGreevy)
...
- BAL @ LAD — LAD faces RHP (Trey Gibson)
- BAL @ LAD — BAL faces RHP (Roki Sasaki)
- BOS @ SEA — SEA faces LHP (Ranger Suarez)
- BOS @ SEA — BOS faces RHP (Bryce Miller)
