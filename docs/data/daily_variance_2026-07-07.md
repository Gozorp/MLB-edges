...
_Generated 2026-07-06T10:29:01Z · 16 games · significant deviations only_
...
- **CHC** Ryan Rolison — 2 apps / 36 pitches over last 3 games — monitor
- **ATH** Elvis Alvarado — 2 apps / 45 pitches over last 3 games — monitor
...
## 4 · Lineup / Platoon
- MIL @ STL — STL faces RHP (Jacob Misiorowski)
- CHC @ BAL — BAL faces LHP (Matthew Boyd)
...
- PHI @ CIN — PHI faces LHP (Andrew Abbott)
- CLE @ MIN — MIN faces LHP (Joey Cantillo)
- CLE @ MIN — CLE faces RHP (Taj Bradley)
- BOS @ CWS — CWS faces LHP (Payton Tolle)
- BOS @ CWS — BOS faces LHP (Noah Schultz)
- LAA @ TEX — TEX faces RHP (José Soriano)
- LAA @ TEX — LAA faces RHP (Jacob deGrom)
- AZ @ SD — SD faces RHP (Zac Gallen)
- TOR @ SF — TOR faces RHP (Trevor McDonald)
- COL @ LAD — LAD faces RHP (Michael Lorenzen)
- COL @ LAD — COL faces LHP (Justin Wrobleski)
