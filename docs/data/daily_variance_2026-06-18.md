...
- **SEA** [IL] — Seattle Mariners transferred 3B Will Wilson from the 10-day injured list to the 60-day injured list. Left thumb fracture.
...
- **TOR** Simeon Woods Richardson — threw 55 pitches last night — likely unavailable
- **MIL** Chad Patrick — threw 50 pitches last night — likely unavailable
...
- TOR @ BOS — TOR faces RHP (Sonny Gray)
- CLE @ MIL — MIL faces LHP (Parker Messick)
- CLE @ MIL — CLE faces LHP (Shane Drohan)
- MIN @ TEX — TEX faces RHP (Joe Ryan)
- MIN @ TEX — MIN faces RHP (Jack Leiter)
- BAL @ SEA — SEA faces RHP (Shane Baz)
