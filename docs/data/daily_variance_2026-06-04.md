...
_Generated 2026-06-04T19:34:41Z · 9 games · significant deviations only_
...
- **NYY** [activated] — New York Yankees activated 3B Amed Rosario from the paternity list.
...
- **ATH** [selected] — Athletics selected the contract of RHP Kade Morris from Las Vegas Aviators.
- **ATH** [recalled] — Athletics recalled RHP Mason Barnett from Las Vegas Aviators.
- **ATH** [optioned] — Athletics optioned RHP Michael Kelly to Las Vegas Aviators.
...
- **PIT** [TRADE] — Pittsburgh Pirates traded RHP Justin Lawrence to Minnesota Twins for cash.
- **HOU** [IL] — Houston Astros placed SS Braden Shewmake on the 10-day injured list retroactive to May 31, 2026. Right adductor strain.
- **HOU** [IL] — Houston Astros activated LHP Josh Hader from the 60-day injured list.
- **HOU** [IL] — Houston Astros transferred SS Carlos Correa from the 10-day injured list to the 60-day injured list. Left ankle tendon injury.
- **HOU** [recalled] — Houston Astros recalled LF Zach Cole from Sugar Land Space Cowboys.
...
- **BAL** Albert Suárez — threw 53 pitches last night — likely unavailable
- **BOS** Ryan Watson — threw 53 pitches last night — likely unavailable
- **CLE** Hunter Gaddis — 2 apps / 37 pitches over last 3 games — monitor
- **MIL** Chad Patrick — 2 apps / 64 pitches over last 3 games — monitor
- **PIT** Yohan Ramírez — threw 40 pitches last night — likely unavailable
- **HOU** AJ Blubaugh — 2 apps / 45 pitches over last 3 games — monitor

## 4 · Lineup / Platoon
- SD @ PHI — PHI faces RHP (Lucas Giolito)
- SD @ PHI — SD faces RHP (Zack Wheeler)
- BAL @ BOS — BOS faces LHP (Trevor Rogers)
- BAL @ BOS — BAL faces RHP (Brayan Bello)
- CLE @ NYY — NYY faces RHP (Slade Cecconi)
...
- ATH @ CHC — CHC faces RHP (J.T. Ginn)
- ATH @ CHC — ATH faces LHP (Shota Imanaga)
- PIT @ HOU — HOU faces RHP (Jared Jones)
- PIT @ HOU — PIT faces RHP (Kai-Wei Teng)
- LAD @ AZ — AZ faces LHP (Justin Wrobleski)
- LAD @ AZ — LAD faces RHP (Ryne Nelson)
