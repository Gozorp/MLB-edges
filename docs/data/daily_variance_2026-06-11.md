...
- **CHC** [status] — Chicago Cubs placed RHP Trent Thornton on the paternity list.
- **CHC** [IL] — Chicago Cubs placed RHP Jameson Taillon on the 15-day injured list retroactive to June 8, 2026. Strained left hamstring.
- **CHC** [IL] — Chicago Cubs activated RF Matt Shaw from the 10-day injured list.
...
- **CHC** [recalled] — Chicago Cubs recalled RHP Ethan Roberts from Iowa Cubs.
- **COL** [DFA] — Colorado Rockies designated RHP Keegan Thompson for assignment.
- **COL** [IL] — Colorado Rockies placed RF Tyler Freeman on the 7-day injured list. Concussion.
...
- **NYM** Jonathan Pintaro — threw 46 pitches last night — likely unavailable
...
- **PIT** Carmen Mlodzinski — threw 76 pitches last night — likely unavailable

## 4 · Lineup / Platoon
- STL @ NYM — NYM faces RHP (Hunter Dobbins)
- STL @ NYM — STL faces RHP (Christian Scott)
- MIN @ DET — DET faces RHP (Zebby Matthews)
- MIN @ DET — MIN faces RHP (Keider Montero)
- AZ @ MIA — MIA faces RHP (Merrill Kelly)
- AZ @ MIA — AZ faces RHP (Tyler Phillips)
- TEX @ KC — KC faces RHP (Kumar Rocker)
- TEX @ KC — TEX faces RHP (Michael Wacha)
- CHC @ COL — COL faces RHP (Edward Cabrera)
- CHC @ COL — CHC faces RHP (Ryan Feltner)
- LAD @ PIT — PIT faces LHP (Justin Wrobleski)
- LAD @ PIT — LAD faces RHP (Mitch Keller)
