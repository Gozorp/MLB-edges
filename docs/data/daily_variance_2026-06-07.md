...
- **ATH** [TRADE] — Athletics traded RHP Joel Kuhnel to Milwaukee Brewers for cash.
...
- **TEX** [IL] — Texas Rangers placed C Danny Jansen on the 10-day injured list retroactive to June 3, 2026. Right forearm strain.
- **TEX** [signed] — Texas Rangers signed free agent C Elias Díaz.
...
- **MIL** [IL] — Milwaukee Brewers placed RHP Quinn Priester on the 60-day injured list. Right thoracic outlet syndrome.
- **MIL** [IL] — Milwaukee Brewers placed LHP Brian Fitzpatrick on the 15-day injured list. Left elbow injury.
- **MIL** [TRADE] — Athletics traded RHP Joel Kuhnel to Milwaukee Brewers for cash.
...
- **SF** [released] — San Francisco Giants released LHP Ryan Borucki.
...
- **ATL** Dylan Dodd — 2 apps / 35 pitches over last 3 games — monitor
- **CWS** Sean Burke — threw 90 pitches last night — likely unavailable
- **BAL** Keegan Akin — 2 apps / 42 pitches over last 3 games — monitor
...
- BOS @ NYY — BOS faces RHP (Cam Schlittler)
- BAL @ TOR — TOR faces RHP (Shane Baz)
- BAL @ TOR — BAL faces RHP (Kevin Gausman)
- SEA @ DET — DET faces RHP (Luis Castillo)
- SEA @ DET — SEA faces RHP (Jack Flaherty)
- TB @ MIA — MIA faces RHP (Griffin Jax)
- TB @ MIA — TB faces RHP (Sandy Alcantara)
- ATH @ HOU — HOU faces LHP (Gage Jump)
- ATH @ HOU — ATH faces RHP (Mike Burrows)
- KC @ MIN — MIN faces LHP (Noah Cameron)
- KC @ MIN — KC faces LHP (Connor Prielipp)
- CIN @ STL — STL faces RHP (Rhett Lowder)
- CIN @ STL — CIN faces RHP (Michael McGreevy)
- CLE @ TEX — TEX faces LHP (Joey Cantillo)
- CLE @ TEX — CLE faces RHP (Jacob deGrom)
- MIL @ COL — COL faces LHP (Shane Drohan)
- MIL @ COL — MIL faces LHP (Kyle Freeland)
- WSH @ AZ — AZ faces RHP (Cade Cavalli)
