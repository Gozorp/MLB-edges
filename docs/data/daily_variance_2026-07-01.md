...
_Generated 2026-06-30T22:18:31Z · 14 games · significant deviations only_
...
- **BAL** [outrighted] — Baltimore Orioles sent C Sam Huff outright to Norfolk Tides.
- **TEX** [signed] — Texas Rangers signed free agent RHP Chris Paddack.
- **TEX** [DFA] — Texas Rangers designated RF Jarred Kelenic for assignment.
- **TEX** [DFA] — Texas Rangers designated RHP Joe Ross for assignment.
...
- **NYY** [recalled] — New York Yankees recalled RHP Yovanny Cruz from Scranton/Wilkes-Barre RailRiders.
...
- **CHC** [outrighted] — Chicago Cubs sent RHP Vince Velasquez outright to Iowa Cubs.
...
- **MIN** [recalled] — Minnesota Twins recalled RHP Cody Laweryson from St. Paul Saints.
- **MIN** [signed] — Minnesota Twins signed free agent RHP Jesus Moreno to a minor league contract.
- **HOU** [IL] — Houston Astros activated SS Nick Allen from the 10-day injured list.
- **HOU** [optioned] — Houston Astros optioned 2B Raynel Delgado to Sugar Land Space Cowboys.
- **HOU** [IL] — Houston Astros placed SS Jeremy Peña on the 10-day injured list. Left calf strain.
- **HOU** [recalled] — Houston Astros recalled 2B Raynel Delgado from Sugar Land Space Cowboys.
- **CIN** [IL] — Cincinnati Reds activated RHP Emilio Pagán from the 15-day injured list.
...
- **MIA** [IL] — Miami Marlins activated C Liam Hicks from the 10-day injured list.
- **MIA** [IL] — Miami Marlins placed RHP Anthony Bender on the 15-day injured list. Right shin stress reaction.
- **MIA** [recalled] — Miami Marlins recalled RHP Zach Brzykcy from Jacksonville Jumbo Shrimp.
- **MIA** [optioned] — Miami Marlins optioned 3B Graham Pauley to Jacksonville Jumbo Shrimp.
- **COL** [IL] — Colorado Rockies activated RHP Tanner Gordon from the 15-day injured list.
...
- **LAD** [DFA] — Los Angeles Dodgers designated RHP Jonathan Hernández for assignment.
- **LAD** [recalled] — Los Angeles Dodgers recalled RHP Wyatt Mills from Oklahoma City Comets.
...
- **ATH** [signed] — Athletics signed free agent 2B Jack Winkler to a minor league contract.
...
- **DET** code=ACQ — Detroit Tigers acquired RHP Maddox Long from the Washington Wild Things of the Frontier League.
- **CIN** code=ACQ — Cincinnati Reds acquired LF Marcus Smith from the Kansas City Monarchs of the American Association.
...
- **CWS @ BAL** (home SP TBD): NOT CONFIRMED — probable SP not posted
- **NYM @ TOR** (home SP TBD): NOT CONFIRMED — probable SP not posted
- **PIT @ PHI** (away SP Paul Skenes): very high K% (30.5% vs lg 22.0)
- **MIN @ HOU** (home SP Tatsuya Imai): very high K% (28.2% vs lg 22.0)

## 3 · Bullpen Fatigue (last 3 games)
- **SD** Jason Adam — 2 apps / 39 pitches over last 3 games — monitor
- **TOR** Louis Varland — 2 apps / 46 pitches over last 3 games — monitor
- **PHI** Chase Shugart — 2 apps / 44 pitches over last 3 games — monitor
- **MIL** Aaron Ashby — 2 apps / 39 pitches over last 3 games — monitor

## 4 · Lineup / Platoon
- CWS @ BAL — BAL faces LHP (Noah Schultz)
- TEX @ CLE — CLE faces LHP (MacKenzie Gore)
- TEX @ CLE — TEX faces LHP (Joey Cantillo)
- WSH @ BOS — BOS faces LHP (Andrew Alvarez)
- WSH @ BOS — WSH faces LHP (Payton Tolle)
- DET @ NYY — NYY faces RHP (Troy Melton)
- DET @ NYY — DET faces RHP (Will Warren)
- SD @ CHC — CHC faces RHP (Walker Buehler)
- SD @ CHC — SD faces RHP (Colin Rea)
- NYM @ TOR — TOR faces RHP (Freddy Peralta)
- PIT @ PHI — PHI faces RHP (Paul Skenes)
- PIT @ PHI — PIT faces RHP (Zack Wheeler)
- STL @ ATL — ATL faces RHP (Michael McGreevy)
- STL @ ATL — STL faces RHP (Reynaldo López)
- TB @ KC — KC faces LHP (Shane McClanahan)
- TB @ KC — TB faces RHP (Seth Lugo)
- MIN @ HOU — HOU faces RHP (Taj Bradley)
- MIN @ HOU — MIN faces RHP (Tatsuya Imai)
- CIN @ MIL — MIL faces LHP (Andrew Abbott)
- CIN @ MIL — CIN faces LHP (Shane Drohan)
- MIA @ COL — COL faces RHP (Max Meyer)
- MIA @ COL — MIA faces LHP (Kyle Freeland)
- LAD @ ATH — ATH faces RHP (Shohei Ohtani)
- LAD @ ATH — LAD faces RHP (J.T. Ginn)
- SF @ AZ — AZ faces RHP (Trevor McDonald)
- SF @ AZ — SF faces RHP (Zac Gallen)
