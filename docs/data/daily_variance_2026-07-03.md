...
_Generated 2026-07-02T22:09:22Z · 13 games · significant deviations only_
...
- **COL** [recalled] — Colorado Rockies recalled RHP Gabriel Hughes from Albuquerque Isotopes.
- **BOS** [IL] — Boston Red Sox placed LHP Connelly Early on the 15-day injured list. Left elbow inflammation.
- **BOS** [IL] — Boston Red Sox activated LHP Jovani Morán from the 15-day injured list.
- **BOS** [DFA] — Boston Red Sox designated RHP Tommy Kahnle for assignment.
- **BOS** [TRADE] — Athletics traded 3B Brett Harris to Boston Red Sox for RHP Ben Hansen.
...
- **ATH** [TRADE] — Athletics traded 3B Brett Harris to Boston Red Sox for RHP Ben Hansen.
- **LAD** [optioned] — Los Angeles Dodgers optioned RHP Wyatt Mills to Oklahoma City Comets.
- **LAD** [recalled] — Los Angeles Dodgers recalled LHP Charlie Barnes from Oklahoma City Comets.
...
- **TOR** [status] — Toronto Blue Jays placed DH George Springer on the paternity list.
- **TOR** [outrighted] — Toronto Blue Jays sent RHP Simeon Woods Richardson outright to Buffalo Bisons.
- **TOR** [recalled] — Toronto Blue Jays recalled LF Jonatan Clase from Buffalo Bisons.
...
_Suppressed 2 minor/cosmetic move(s) (ASG/NUM); 1 unrecognized code-type(s) -> logs/unknown_tx_codes.log._
...
- **CIN** Brock Burke — 2 apps / 37 pitches over last 3 games — monitor
- **BOS** Ryan Watson — 2 apps / 42 pitches over last 3 games — monitor
- **MIA** Cade Gibson — 2 apps / 54 pitches over last 3 games — monitor
- **MIL** Jared Koenig — 2 apps / 37 pitches over last 3 games — monitor
- **AZ** Taylor Clarke — 2 apps / 36 pitches over last 3 games — monitor
...
- BAL @ CIN — CIN faces LHP (Trevor Rogers)
- BAL @ CIN — BAL faces RHP (Brady Singer)
- CWS @ CLE — CLE faces LHP (Anthony Kay)
...
- TOR @ SEA — SEA faces RHP (Dylan Cease)
- TOR @ SEA — TOR faces RHP (Luis Castillo)
