...
- **CHC @ NYM** (home SP TBD): NOT CONFIRMED — probable SP not posted
- **CHC @ NYM** (away SP TBD): NOT CONFIRMED — probable SP not posted
- **CHC @ NYM** (home SP TBD): NOT CONFIRMED — probable SP not posted
- **PHI @ WSH** (home SP Miles Mikolas): very low K% (13.8% vs lg 22.0)
- **LAD @ MIN** (away SP Shohei Ohtani): very high K% (29.0% vs lg 22.0)
...
## 4 · Lineup / Platoon
- TEX @ MIA — MIA faces RHP (Jacob deGrom)
- CLE @ CWS — CWS faces RHP (Tanner Bibee)
- CLE @ CWS — CLE faces RHP (Erick Fedde)
- BOS @ COL — COL faces LHP (Ranger Suarez)
- BOS @ COL — BOS faces LHP (Kyle Freeland)
- BAL @ LAA — LAA faces RHP (Trey Gibson)
- BAL @ LAA — BAL faces RHP (José Soriano)
- SEA @ PIT — PIT faces RHP (Bryan Woo)
- SEA @ PIT — SEA faces RHP (Braxton Ashcraft)
- KC @ TB — TB faces LHP (Noah Cameron)
- KC @ TB — KC faces RHP (Griffin Jax)
- NYY @ DET — DET faces LHP (Ryan Weathers)
- NYY @ DET — NYY faces LHP (Tarik Skubal)
- PHI @ WSH — WSH faces RHP (Aaron Nola)
- PHI @ WSH — PHI faces RHP (Miles Mikolas)
- HOU @ TOR — TOR faces RHP (Mike Burrows)
- HOU @ TOR — HOU faces RHP (Trey Yesavage)
- MIL @ CIN — CIN faces LHP (Shane Drohan)
- MIL @ CIN — MIL faces RHP (Rhett Lowder)
- LAD @ MIN — MIN faces RHP (Shohei Ohtani)
- LAD @ MIN — LAD faces LHP (Connor Prielipp)
- AZ @ STL — AZ faces LHP (Matthew Liberatore)
- ATL @ SD — SD faces LHP (Martín Pérez)
- ATL @ SD — ATL faces RHP (Randy Vásquez)
- ATH @ SF — SF faces LHP (Gage Jump)
- ATH @ SF — ATH faces RHP (Tyler Mahle)
